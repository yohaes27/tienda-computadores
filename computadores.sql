...
-- Tiempo de generación: 02-07-2025 a las 20:37:27
...
(1, 'jose\r\n', 'jose@gmail.com', 'admin', 'admin'),
(2, 'Maria', 'maria@gmail.com', 'user', 'cliente');
...
--
ALTER TABLE `productos`
  ADD CONSTRAINT `productos_ibfk_1` FOREIGN KEY (`precio`) REFERENCES `categorias` (`id`);
COMMIT;
