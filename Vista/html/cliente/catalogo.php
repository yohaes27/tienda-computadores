...
<body>
  ...
  <section id="catalogo">
    ...
    <div>
      <form action="index.php?accion=ordenarClientes" method="post">
    ...
    <div class="productos">
      ...
      ?>
        <div class="producto">
          ...
          <form action="index.php?accion=pedido" method="post">
  ...
  <?php
    if($inicio==0){
            ...
            $anterior=$inicio-6;
            echo "<a href='index.php?accion=catalogoClientes2&pos=$anterior'>Anteriores </a>";
        }
        if($impresos==6){
            $proximo=$inicio+6;
            echo "<a href='index.php?accion=catalogoClientes2&pos=$proximo'>Siguientes</a>";
        }
        else{
            echo "Siguientes";
        }
